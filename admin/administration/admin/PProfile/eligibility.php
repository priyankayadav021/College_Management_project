...
$hisofbk = $_POST['hob'];
$dety = $_POST['dy'];
$sql11 = "SELECT * FROM basicdetails where Approve=1 and Branch='$branch' and SSLC>='$sslc' and `PU/Dip`>='$puaggregate' and BE>='$beaggregate' and Backlogs='$backlogs' and HofBacklogs='$hisofbk' and DetainYears='$dety'" ; 
 //run the query

 $sql1 = mysqli_query($conn,$sql11);
...
$sqlq = "SELECT * FROM basicdetails where Approve='1'"; 
$rs_result = mysqli_query($connect,$sqlq); //run the query
