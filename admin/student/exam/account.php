...
{
$eid=@$_GET['eid'];
$q=mysqli_query($con,"SELECT * FROM history WHERE eid='$eid' AND email='$semail' " )or die('Error157');
...
$q=mysqli_query($con,"SELECT * FROM rank WHERE  email='$semail' " )or die('Error157');
while($row=mysqli_fetch_array($q) )
{
$s=$row['score'];
